...
\begin{document}
  ...
  \section{Generales}
    ...
    \includecpp{Lectura rápida de enteros}{./general}{input.cpp}
  ...
  \section{Grafos}
    ...
    \includecpp{Componentes fuertemente conexas (Tarjan)}{./graphs/scc}{tarjan.cpp}
    ...
    \includecpp{Flujo máximo}{./graphs/max_flow}{ford_fulkerson.cpp}
    \includecpp{Flujo máximo (Dinic)}{./graphs/max_flow}{dinic.cpp}
    \includecpp{Flujo máximo - Costo Mínimo (Succesive Shortest Path)}{./graphs}{mcmf_ssp.cpp}
    \includecpp{Flujo máximo (Dinic + Lower Bounds)}{./graphs/max_flow}{lower_bound_dinic.cpp}
  ...
  \section{Cadenas}
    ...
    \includecpp{Suffix array}{./strings/suffix_array}{dc3.cpp}
    %\includecpp{Trie}{./strings}{trie.cpp}
    \includecpp{Aho-Corasick}{./strings}{Aho_Corasick.cpp}
    \includecpp{Rotación lexicográfica mínima}{./strings}{mininum_rotation.cpp}
  ...
  \section{Geometría}
    ...
    \includecpp{Líneas}{./geometry}{line_functions.cpp}
